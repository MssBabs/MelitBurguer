...
import { ProductosPedidoComponent } from 'app/entities/productos-pedido/productos-pedido.component';
...
describe('Component Tests', () => {
  describe('ProductosPedido Management Component', () => {
    let comp: ProductosPedidoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductosPedidoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productosPedidos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
