...
import { RecompensaComponent } from 'app/entities/recompensa/recompensa.component';
...
describe('Component Tests', () => {
  describe('Recompensa Management Component', () => {
    let comp: RecompensaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RecompensaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.recompensas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
